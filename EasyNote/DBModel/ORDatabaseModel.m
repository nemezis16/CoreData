...
NSString* const ORTextDescriptionKey=@"textDescription";
NSString* const ORDateStampKey=@"timeStamp";

NSString* const ORPhotoDataKey=@"photoData";
NSString* const ORPhotoNumberKey=@"photoNumber";
NSString* const ORPhotoNameKey=@"photoName";

NSString* const OREntityPhotoKey=@"Photo";
NSString* const OREntityNoteKey=@"Note";
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"EasyNote" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [applicationDocumentsDirectory URLByAppendingPathComponent:@"EasyNote.sqlite"];
